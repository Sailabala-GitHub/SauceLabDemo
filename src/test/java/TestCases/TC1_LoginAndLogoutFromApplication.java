...
public class TC1_LoginAndLogoutFromApplication extends BaseClass
{
	...
	{
		Reporter.LogEvent(driver, "Info", "", "Start of Execution  - TC1_LoginAndLogoutFromApplication");
		...
		Reporter.LogEvent(driver, "Info", "", "End of Execution  - TC1_LoginAndLogoutFromApplication");
	}
}
