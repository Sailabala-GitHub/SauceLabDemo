...
public class TC2_AddRemoveItems extends BaseClass
{
	...
	{
		Reporter.LogEvent(driver, "Info", "", "Start of Execution  - TC2_AddRemoveItems");
		...
		//Add a product
		Assert.assertTrue(home.AddAProduct(productName),"Step2 - Unable to add a product");
		...
		//Remove a Product
		Assert.assertTrue(home.RemoveAProduct(productName),"Step4 - Unable to remove a product");
		Reporter.LogEvent(driver, "Pass", "Step4", "Successfully removed a product from cart");
		
				
		Reporter.LogEvent(driver, "Info", "", "End of Execution  - TC2_AddRemoveItems");
